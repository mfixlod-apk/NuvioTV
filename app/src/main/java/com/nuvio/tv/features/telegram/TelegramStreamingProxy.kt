...
object TelegramStreamingProxy {
    ...
    fun start() {
        ...
        server = embeddedServer(CIO, port = port) {
            routing {
                get("/file/{fileId}") {
                    ...
                    Log.d("Telegram", "FileInfo: fileId=$fileId totalSize=$totalSize localPath=$localPath" )
        ...
        Log.d("Telegram", "Streaming proxy started on port $port" )
    }
    ...
    fun stop() {
        ...
        server?.stop(0, 0)
        server = null
        Log.d("Telegram", "Streaming proxy stopped" )
    }
    ...
    private suspend fun deleteFile(fileId: Int) {
        ...
        runCatching {
            ...
            Log.d("Telegram", "Deleted cached file $fileId" )
        }
    }
    ...
    fun getUrl(fileId: Int): String {
        ...
        Log.d("Telegram", "Generated stream URL: $url" )
        return url
    }
